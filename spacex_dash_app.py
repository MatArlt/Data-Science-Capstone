...
def update_scatter_plot(selected_site, selected_payload_range):
    ...
    # Plot scatter chart for Payload Mass vs Success/Failure
    fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category',
                     title=f'Success vs Payload for {selected_site}' if selected_site != 'ALL' else 'Success vs Payload for All Sites')
    return fig
